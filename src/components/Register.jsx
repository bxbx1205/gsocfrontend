    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: '#01132b' }}>
      ...
      <div className="rounded-lg w-full max-w-4xl overflow-hidden" style={{ backgroundColor: '#02284d' }}>
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 flex items-center justify-center p-20" style={{ backgroundColor: '#03588C' }}>
            <div className="text-white text-center">
              <h1 className="text-3xl font-semibold">Website name and a</h1>
              <h2 className="text-3xl font-semibold">little tagline shit</h2>
            </div>
          </div>
          ...
          <div className="p-8 md:w-1/2 text-white">
            ...
            <p className="text-gray-300 mb-6">already have an account? log in.</p>
            ...
            <form className="space-y-4">
              ...
              <div className="text-right mb-4">
                <a href="#" className="text-gray-300 text-sm">Forgot password?</a>
              </div>
